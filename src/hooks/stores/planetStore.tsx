...
interface planetDurabilityState {
  durability?: number;
  ON?: boolean;
}
...
interface planetResourcesState {
  [index: string]: string;
}

interface planetState {
  planetName: Array<string>;
  explanation: object;
  types: object;
  size: sizeState;
  selectPlanet: object;
  planetResources: planetResourcesState;
  planetDurability: Array<planetDurabilityState>;
}

export const planetStore = create(
  subscribeWithSelector<planetState, any, any, any>((set) => ({
    planetName: [
      "Pernille",
      "Kathleen",
      "Sondre",
