...
export const effectStore = create(
  subscribeWithSelector((set) => ({
    ...
    negativeEffects: [
      { name: "포자 지대", resources: { gear: 5 }, description: "포자" },
      { name: "적대적 환경", resources: { gear: 5 }, description: "적대적" },
      { name: "불길한 흔적", resources: { gear: 5 }, description: "불길한" },
      { name: "벌레 무리", resources: { gear: 5 }, description: "벌레" },
    ],
